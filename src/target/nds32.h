...
extern int nds32_write_buffer(struct target *target, long unsigned int address,
		uint32_t size, const uint8_t *buffer);
extern int nds32_read_buffer(struct target *target, long unsigned int address,
		uint32_t size, uint8_t *buffer);
extern int nds32_read_memory(struct target *target, long unsigned int address,
		uint32_t size, uint32_t count, uint8_t *buffer);
extern int nds32_write_memory(struct target *target, long unsigned int address,
...
extern int nds32_get_mapped_re64g(struct nds32 *nds32, unsigned regnum, uint64_t *value);
extern int nds32_set_mapped_reg64(struct nds32 *nds32, unsigned regnum, uint64_t value);
...
extern int nds32_virtual_to_physical(struct target *target, uint64_t address,
		uint64_t *physical);
extern int nds32_read_phys_memory(struct target *target, uint64_t address,
		uint32_t size, uint32_t count, uint8_t *buffer);
extern int nds32_write_phys_memory(struct target *target, uint64_t address,
		uint32_t size, uint32_t count, const uint8_t *buffer);
