...
int nds32_v3_read_buffer(struct target *target, uint64_t address,
		uint32_t size, uint8_t *buffer)
{
	struct nds32 *nds32 = target_to_nds32(target);
...
int nds32_v3_write_buffer(struct target *target, uint64_t address,
...
int nds32_v3_read_memory(struct target *target, uint64_t address,
...
int nds32_v3_write_memory(struct target *target, uint64_t address,
